...
namespace 飞行棋项目编写
{
    class Program
    {
        ...
        //声明一个静态数组用来存储玩家A跟玩家B的左标
        public static int[] PlayerPos = new int[2];
        //存储两个玩家的姓名
        public static string[] PlayerNames = new string[2];
        //两个玩家的标记
        public static bool[] Flags = new bool[2];//Flags[0]默认是false，Flags[1]默认是true
        static void Main(string[] args)
        {
            ...
            Initai1Map();
            DrawMap();
            //当玩家A跟玩家B没有一个人在终点的是时候,两个玩家不停的去玩游戏
        ...
        public static string DrawStringMap(int i)
        {
            string str = "";
            #region 画图
            //如果玩家A跟玩家B的坐标相同，并且都在这个地图上，才画一个尖括号
        ...
        public static void PlayGame(int playerNumber)
        {
            ...
            Console.WriteLine("{0}投掷出了{1}", PlayerNames[playerNumber],rNumber);
            ...
            else//踩到了关卡
            {
                ...
                {
                    case 0:
                        Console.WriteLine("玩家{0}踩到方块，安全", PlayerNames[playerNumber]);
                        Console.ReadKey(true);
                        break;
                    case 1:
                        Console.WriteLine("玩家{0}踩到了幸运轮盘，请选择1----交换位置  2----轰炸对方，使对方退6格：");
